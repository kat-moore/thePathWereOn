...
[RequireComponent(typeof(CountDownTimeeee))]
public class FadeAwayyyy : MonoBehaviour
{
    //
    private CountDownTimeeee countDownTimer;
    private Text textUI;
    ...
    void Start()
    {
        ...
        countDownTimer = GetComponent<CountDownTimeeee>();
